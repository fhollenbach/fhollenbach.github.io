...
On this website you can find an overview of my [published research](/publications.html), [my working papers](sites/workingPapers.html), and [my teaching](sites/teaching.html). Here are links to [my CV](papers/HOLLENBACH-2018-CV.pdf), [my Google Scholar page](https://scholar.google.com/citations?user=1B4nx4oAAAAJ&hl=en) and my [Dataverse](https://dataverse.harvard.edu/dataverse/fhollenbach).
